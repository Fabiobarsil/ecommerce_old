...
<html lang="pt-br">
  <head>
    ...
    <title>Loja Virtual BIBLIEx</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="file:///C:/ecommerce/res/admin/index.html#"><i class="fa fa-user"></i> Minha Conta</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="carrinho.html">Carrinho - <span class="cart-amunt">R$0,00</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">0</span></a>
                    </div>
                </div>
            </div>
        </div>
